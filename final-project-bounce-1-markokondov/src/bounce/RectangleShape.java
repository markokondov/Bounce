...
public class RectangleShape extends Shape {
    ...
    public RectangleShape(String text, int x, int y, int deltaX, int deltaY) {
    ...
    public RectangleShape(String text, int x, int y, int deltaX, int deltaY, int width, int height) {
